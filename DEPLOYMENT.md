...
2. **Create a New Web Service**
   ...
   - For the build and start commands, use:
     - **Build Command:** `python -m pip install --upgrade pip setuptools wheel --force-reinstall && python -m pip install -r requirements.txt --no-build-isolation && python source/manage.py collectstatic --noinput`
